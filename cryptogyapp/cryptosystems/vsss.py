...
X_K = [
    [R, G, B, Y, M, C, K, K, K, K, K, W],
    [B, R, G, K, K, K, Y, M, C, K, W, K],
]

X_R = [
    [R, G, B, Y, M, C, K, K, K, K, K, W],
    [B, K, G, K, K, K, Y, M, C, K, W, R],
]

X_G = [
    [R, G, B, Y, M, C, K, K, K, K, K, W],
    [B, R, K, K, K, K, Y, M, C, K, W, G],
]

X_B = [
    [R, G, B, Y, M, C, K, K, K, K, K, W],
    [K, R, G, K, K, K, Y, M, C, K, W, B],
]

X_Y = [
    [R, G, B, Y, M, C, K, K, K, K, K, W],
    [B, R, G, K, K, K, W, M, C, K, K, Y],
]

X_M = [
    [R, G, B, Y, M, C, K, K, K, K, K, W],
    [B, R, G, K, K, K, Y, W, C, K, K, M],
]

X_C = [
    [R, G, B, Y, M, C, K, K, K, K, K, W],
    [B, R, G, K, K, K, Y, M, W, K, K, C],
]

X_W = [
    [R, G, B, Y, M, C, K, K, K, K, K, W],
    [B, R, G, K, K, K, Y, M, C, K, K, W],
]
